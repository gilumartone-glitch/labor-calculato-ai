...
import { Calculator, Workflow, Landmark, LogOut, Loader2, ShieldCheck, Factory, Package, Megaphone, HardHat, Hammer, BookMarked, Users } from "lucide-react";
...
const TILES: Tile[] = [
  ...
  { key: "flow",         label: "Flow",          description: "Le mie Attività",                  to: "/produzione/oggi",          Icon: Workflow,   color: "bg-[hsl(225_58%_42%)] text-white border-[hsl(225_58%_28%)]", iconBg: "bg-[hsl(225_58%_28%)]" },
