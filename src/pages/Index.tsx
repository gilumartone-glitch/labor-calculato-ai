  ...
  return (
    <div data-dept={activeTab} className="min-h-screen bg-dept-soft/35 transition-colors">
      ...
      <header className="app-header border-b-2 border-dept bg-paper sticky top-0 z-20">
        <div className="container mx-auto px-3 sm:px-6 lg:px-8 py-2 md:py-5 flex flex-wrap items-center justify-between gap-2 md:gap-6">
      ...
      {/* Barra schede progetto + Invia al Flow */}
      <DraftTabsBar />

      {/* Body */}
      <main className="container mx-auto px-3 sm:px-6 lg:px-8 py-4 md:py-8 pb-20">
      ...
      <footer className="border-t-2 border-ink bg-paper">
        <div className="container mx-auto px-3 sm:px-6 lg:px-8 py-5 flex items-center justify-between font-mono text-[10px] uppercase tracking-widest text-muted-foreground">
